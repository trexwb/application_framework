 ...
 * @LastEditors: trexwb
 * @LastEditTime: 2025-01-03 17:47:36
...
const baseHelper = {
  ...
  update: async function (where, data) {
    ...
    // const sortWhere = utils.sortMultiDimensionalObject(where);
    // const cacheKey = `${this.$cacheKey}[update:${JSON.stringify([field, sortWhere])}]`;
  ...
  restore: async function (where) {
    if (!this.$model || !where) return null;
    // const sortWhere = utils.sortMultiDimensionalObject(where);
    // const cacheKey = `${this.$cacheKey}[restore:${JSON.stringify([field, sortWhere])}]`;
    // const release = await mutex.acquire(cacheKey);
    try {
  ...
  delete: async function (where) {
    if (!this.$model || !where) return null;
    // const sortWhere = utils.sortMultiDimensionalObject(where);
    // const cacheKey = `${this.$cacheKey}[delete:${JSON.stringify([field, sortWhere])}]`;
    // const release = await mutex.acquire(cacheKey);
    try {

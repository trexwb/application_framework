 ...
 * @LastEditors: trexwb
 * @LastEditTime: 2024-05-13 15:04:30
 * @FilePath: /laboratory/application/drive/src/app/service/interface/caajwcPrint.js
 * @Description: 
 * @一花一世界，一叶一如来
...
module.exports = {
  ...
  setServer: async function () {
    this.serverRow = await serversHelper.getKey('caajwcPrint');
    if (!this.serverRow) {
			throw false;
		}
  },

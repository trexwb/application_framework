...
- 重构 baseHelper 中的缓存处理逻辑，提高可读性和维护性
- 优化 baseModel 中的查询、更新和保存方法，提高错误处理和响应构建的可读性
- 移除未使用的 handleDeletedAtQuery 函数，直接在查询中处理 deleted_at 字段
- 调整日期格式化处理，统一使用 formatDateTime 方法
- 优化 SQL 查询，使用链式调用替代原生 SQL 语句
- 增加对数组类型 id 的处理，提高方法的灵活性
